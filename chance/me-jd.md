...
- 学士学位 | 西南科技大学 | 软件工程 | 2013.09 - 2017.06

## 工程能力

- 具备多年前端架构与工程化经验，专注于大中型前端架构设计、低代码平台、数据可视化与性能治理。
- 曾多次主导前端平台从 0 到 1 建设，擅长在复杂业务场景中进行系统抽象与架构演进。
- 熟悉微前端、低代码、CI/CD 自动化等技术体系，在组件化、性能优化、 PC 端、小程序、H5 等跨端协作方面有丰富落地经验。
- 熟悉 MCP、JSON-RPC、RAG 等 AI 相关技术，有 MCP-Server 编写经验。

## 核心优势

- 技术能力：精通 Vue2 / Vue3 / React / Taro，熟悉复杂系统性能优化与前端工程化建设，掌握 Webpack、Vite、模块化与组件化设计。
- 架构能力：具备优秀的需求抽象与架构设计能力，主导过多个平台级前端项目，从 0 到 1 搭建工程体系，熟悉微前端、低代码、前端可视化架构设计。
...
高级前端工程师 | 职级：T3.2 | 2023.08 ～ 2025.12
...
可视化分析工程师 | 2023.05 ～ 2023.07

离职原因：4 月底入职、6 月底离职。入职后，公司的资金链断裂。自领导层到普通员工，被降薪、延迟发薪，因此离职。

### 深圳市位元领航科技有限公司

Web 研发工程师 | 2020.11 ～ 2023.04
...
离职原因：与志同道合的朋友一起创业，组建创业公司《深圳市位元领航科技有限公司》，负责公司前端工程体系建设。

### 深圳市联软科技股份有限公司

JavaWeb 工程师 | 2017.07 ～ 2020.05
...
### 前端模块分析 | 2025.09 ~ 2025.12 | 深圳市跨越速运集团有限公司

基于 MCP（Model Context Protocol） 规范实现的前端工程工具服务，通过 JSON-RPC + 标准输入输出流 向 IDE 暴露前端领域能力（文件分析、热点模块分析、Git 变更影响点等），用于增强 LLM 在真实前端工程场景中的可操作性。

- 项目职责

  - 负责 MCP Server 核心架构设计与实现，支持 initialize / capabilities / resources / tools 等协议能力。
  - 基于 JSON-RPC 2.0 实现请求分发与通知机制，设计并实现 SSE 长连接通信机制。
  - 将前端工程能力抽象为 Tool / Resource，支持文件读取、工程结构解析、模块依赖分析等核心场景。
  - 采用模块化架构设计（dispatcher / resources / tool-set），支持工具能力的扩展与插件化演进。

- 成果亮点
  - 成功集成至 VS Code，作为 AI 工程能力服务供 Chat AI / Agent 调用
  - 支持 热点模块分析 与 Git 变更影响点定位，辅助 AI 进行风险评估与修改决策
  - 提升 AI 对前端项目结构与演进关系的理解能力，降低上下文缺失导致的误判问题

### 股票资源池 | 2024.11 ～ 2025.12 | 深圳市跨越速运集团有限公司
...
### 无感录屏系统 | 2024.08 ～ 2024.11 | 深圳市跨越速运集团有限公司
...
### 点击量热力图 | 2024.02 ～ 2024.11 | 深圳市跨越速运集团有限公司
...
### 鲲鹏离线开发平台 | 2023.07 ～ 2024.11 | 深圳市跨越速运集团有限公司
...
### 配置下单系统 | 2023.10 ～ 2024.02 | 深圳市跨越速运集团有限公司
...
### Labrador 主机安全管理系统 | 2020.11 ～ 2023.04 | 深圳市位元领航科技有限公司
...
### 可视化表单低代码平台 | 2020.06 ～ 2020.10 | 深圳市共济科技股份有限公司
