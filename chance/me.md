...
- 熟悉 Vue2/3、React、微前端、低代码平台、CI/CD 自动化 等技术体系，在组件化、性能优化、 PC 端、小程序、H5 等跨端协作方面有丰富落地经验。

## 核心优势

- 技术能力：精通 Vue2 / Vue3 / React，熟悉复杂系统性能优化与前端工程化建设，掌握 Webpack、Vite、模块化与组件化设计; 处理 PC 端、小程序、H5 等多端项目。
